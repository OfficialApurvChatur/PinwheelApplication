    ...
    <>
      <Card 
        className={`
          ...
          bg-[#CCF381] dark:bg-[#4831D4]
          border-[#4831D4] dark:border-[#CCF381]
          text-[#4831D4] dark:text-[#CCF381]`}
      >
        <CardHeader className="flex flex-row items-center justify-between py-2 border-b border-[#4831D4] dark:border-[#CCF381]">
        ...
        <CardFooter className="py-2 border-y border-[#4831D4] dark:border-[#CCF381] bottom-0">
          <form className="flex w-full items-center space-x-2">
            <Input
              id="message"
              placeholder="Type your message..."
              className="flex-1 border-[#4831D4] dark:border-[#CCF381]"
              autoComplete="off"
              value={input}
