              ...
              return (
                <React.Fragment key={index} >
                  <div className="p-4 md:w-1/2">
                    <div className="flex rounded-lg h-full bg-[#4831D4] dark:bg-[#CCF381] text-[#CCF381] dark:text-[#4831D4] bg-opacity-60 p-8 flex-col">
                      <div className="flex items-center mb-3">
                        <div className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-[#CCF381] dark:bg-[#4831D4] text-[#4831D4] dark:text-[#CCF381] flex-shrink-0">
