              ...
              return (
                <React.Fragment key={index}>
                  <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                    <div className="bg-[#4831D4] dark:bg-[#CCF381] text-[#CCF381] dark:text-[#4831D4] bg-opacity-60 px-4 py-6 rounded-lg">
                      {
                        each.title === "Frontend Application Deployed" ? (
                          <div className="w-12 h-12 mb-3 inline-flex items-center justify-center rounded-full bg-[#CCF381] dark:bg-[#4831D4] text-[#4831D4] dark:text-[#CCF381] flex-shrink-0">
