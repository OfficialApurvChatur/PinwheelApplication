...
const ProfileUpdateComponent = ({ Redux, EventHandler, OnClick }) => {
  ...
  return (
    <React.Fragment>
      <section className="bg-[#CCF381] dark:bg-[#4831D4] text-[#4831D4] dark:text-[#CCF381] lg:px-20">
          ...
          <div className="lg:w-4/6 mx-auto">
            ...
            <div className="flex flex-col sm:flex-row mt-10">
              <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div className="w-20 h-20 rounded-full inline-flex items-center justify-center bg-[#4831D4] dark:bg-[#CCF381] text-[#CCF381] dark:text-[#4831D4]">
                ...
                <div className="flex flex-col items-center text-center justify-center">
                  ...
                  <div className="w-12 h-1 bg-[#4831D4] dark:bg-[#CCF381] rounded mt-2 mb-4"></div>
                  <p className="text-base">{Redux.state.ReceivedObject?.Retrieve?.subtitle}</p>
                </div>
              </div>
              <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-[#4831D4] dark:border-[#CCF381] sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
        ...
        <div className="container px-5 py-12 mx-auto">
          <div className="flex flex-wrap -m-4">
            ...
            <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#4831D4] dark:border-[#CCF381] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#4831D4] dark:border-[#CCF381] leading-none">Critical Information</h1>
                    ...
                    <div className='mb-2 mt-1 flex flex-1 space-x-4 items-center'>
                      <p>
                        <Avatar>
                          ...
                          <AvatarFallback className="bg-[#4831D4] dark:bg-[#CCF381] text-[#CCF381] dark:text-[#4831D4]">
                ...
                <div className="w-full mb-2">
                  <div className="relative">
                    ...
                    <input 
                      className="w-full bg-[#CCF381] dark:bg-[#4831D4] bg-opacity-40 rounded border 
                        border-[#4831D4] dark:border-[#CCF381]
                        focus:border-[#CCF381] dark:focus:border-[#4831D4] 
                        focus:bg-[#4831D4] dark:focus:bg-[#CCF381] 
                        focus:text-[#CCF381] dark:focus:text-[#4831D4] 
                        focus:ring-2 
                        focus:ring-[#4831D4] dark:focus:ring-[#CCF381] 
                        text-[#4831D4] dark:text-[#CCF381] 
            ...
            <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#4831D4] dark:border-[#CCF381] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#4831D4] dark:border-[#CCF381] leading-none">Basic Information</h1>
            ...
            <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#4831D4] dark:border-[#CCF381] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#4831D4] dark:border-[#CCF381] leading-none">More Information</h1>

                <div className="w-full mb-2">
                  <div className="relative">
                    <label className="leading-7 text-sm">Address</label>
                    <input 
                      className="mb-2 w-full bg-[#CCF381] dark:bg-[#4831D4] bg-opacity-40 rounded border 
                        border-[#4831D4] dark:border-[#CCF381]
                        focus:border-[#CCF381] dark:focus:border-[#4831D4] 
                        focus:bg-[#4831D4] dark:focus:bg-[#CCF381] 
                        focus:text-[#CCF381] dark:focus:text-[#4831D4] 
