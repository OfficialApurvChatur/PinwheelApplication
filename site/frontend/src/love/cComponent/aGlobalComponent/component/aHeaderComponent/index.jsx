...
function HeaderComponent({ Redux, LogoutAPICall }) {
  return (
    ...
    <React.Fragment>
      <header className="sticky top-0 z-50 w-full backdrop-blur supports-[backdrop-filter]:bg-[#CCF381]/60 dark:supports-[backdrop-filter]:bg-[#4831D4]/60 text-[#4831D4] dark:text-[#CCF381]">
